...
-- CreateIndex
CREATE INDEX "Egress_streamId_idx" ON "Egress"("streamId");

-- CreateIndex
CREATE INDEX "Egress_egressId_idx" ON "Egress"("egressId");
...
-- AddForeignKey
ALTER TABLE "Egress" ADD CONSTRAINT "Egress_streamId_fkey" FOREIGN KEY ("streamId") REFERENCES "Stream"("id") ON DELETE CASCADE ON UPDATE CASCADE;
